...
void World::Start() {
  ...
  SubscribeToEvent(E_WORKITEMCOMPLETED,
                   URHO3D_HANDLER(World, HandlWorkItemCompleted));
}
...
void World::SetMaterial(Material* material) { material_ = material; }

Material* World::GetMaterial(void) { return material_; }
...
void World::HandlWorkItemCompleted(StringHash eventType,
...
Vector3 World::GetWorldSize() { return Vector3(size_ * chunkSize_); }
